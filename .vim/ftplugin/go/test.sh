...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftplugin%2Fgo%2Ftest.sh&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftplugin%2Fgo%2Ftest.sh" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
><td class="source">#!/bin/bash -e<br></td></tr
><tr
...
><td class="source"># Copyright 2012 The Go Authors. All rights reserved.<br></td></tr
><tr
...
><td class="source"># Tests for import.vim.<br></td></tr
><tr
...
><td class="source">cd $(dirname $0)<br></td></tr
><tr
...
><td class="source">cat &gt; base.go &lt;&lt;EOF<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_12

><td class="source">package test<br></td></tr
><tr
...
><td class="source">	&quot;mycorp/foo&quot;<br></td></tr
><tr
...
><td class="source">fail=0<br></td></tr
><tr
...
><td class="source"># usage: test_one new_import pattern<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_26

><td class="source"># Pattern is a PCRE expression that will match across lines.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_27

><td class="source">test_one() {<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_28

><td class="source">  echo 2&gt;&amp;1 -n &quot;Import $1: &quot;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_29

><td class="source">  vim -e -s -u /dev/null -U /dev/null --noplugin -c &quot;source import.vim&quot; \<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_30

><td class="source">    -c &quot;Import $1&quot; -c &#39;wq! test.go&#39; base.go<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_31

><td class="source">  # ensure blank lines are treated correctly<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_32

><td class="source">  if ! gofmt test.go | cmp test.go; then<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_33

><td class="source">    echo 2&gt;&amp;1 &quot;gofmt conflict&quot;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_34

><td class="source">    gofmt test.go | diff -u test.go - | sed &quot;s/^/\t/&quot; 2&gt;&amp;1<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_35

><td class="source">    fail=1<br></td></tr
><tr
...
><td class="source">  if ! grep -P -q &quot;(?s)$2&quot; test.go; then<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_39

><td class="source">    echo 2&gt;&amp;1 &quot;$2 did not match&quot;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_40

><td class="source">    cat test.go | sed &quot;s/^/\t/&quot; 2&gt;&amp;1<br></td></tr
><tr
...
><td class="source">  echo 2&gt;&amp;1 &quot;ok&quot;<br></td></tr
><tr
...
><td class="source">test_one baz &#39;&quot;baz&quot;.*&quot;bytes&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_48

><td class="source">test_one io/ioutil &#39;&quot;io&quot;.*&quot;io/ioutil&quot;.*&quot;net&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_49

><td class="source">test_one myc &#39;&quot;io&quot;.*&quot;myc&quot;.*&quot;net&quot;&#39;  # prefix of a site prefix<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_50

><td class="source">test_one nat &#39;&quot;io&quot;.*&quot;nat&quot;.*&quot;net&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_51

><td class="source">test_one net/http &#39;&quot;net&quot;.*&quot;net/http&quot;.*&quot;mycorp/foo&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_52

><td class="source">test_one zoo &#39;&quot;net&quot;.*&quot;zoo&quot;.*&quot;mycorp/foo&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_53

><td class="source">test_one mycorp/bar &#39;&quot;net&quot;.*&quot;mycorp/bar&quot;.*&quot;mycorp/foo&quot;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_54

><td class="source">test_one mycorp/goo &#39;&quot;net&quot;.*&quot;mycorp/foo&quot;.*&quot;mycorp/goo&quot;&#39;<br></td></tr
><tr
...
><td class="source">rm -f base.go test.go<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_57

><td class="source">if [ $fail -gt 0 ]; then<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_58

><td class="source">  echo 2&gt;&amp;1 &quot;FAIL&quot;<br></td></tr
><tr
...
><td class="source">echo 2&gt;&amp;1 &quot;PASS&quot;<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 on Jul 29, 2012
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=9bf2225c38ebaf4341f7568a6ce24de4caf0c751&amp;format=side&amp;path=/misc/vim/ftplugin/go/test.sh&amp;old_path=/misc/vim/ftplugin/go/test.sh&amp;old=">Diff</a>
 </div>
...
...</pre>
 ...
 var selected_path = '/misc/vim/ftplugin/go/test.sh';
 ...
 <a href="/p/go/source/list?path=/misc/vim/ftplugin/go/test.sh&r=9bf2225c38ebaf4341f7568a6ce24de4caf0c751">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//go.googlecode.com/hg/misc/vim/ftplugin/go/test.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn272e1dd72156cbe4b548c37be8285f38c39ccbb9': '/misc/vim/ftplugin/go/test.sh'}
