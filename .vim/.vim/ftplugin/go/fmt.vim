...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftplugin%2Fgo%2Ffmt.vim&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftplugin%2Fgo%2Ffmt.vim" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <li><a href="/p/go/source/browse/misc/vim/ftplugin/go/fmt.vim?r=0b1f004f9c1865461394bf3101dbbb39095fc3eb" title="Previous">&lsaquo;0b1f004f9c18</a></li>
...
><td class="source">&quot; fmt.vim: Vim command to format Go files with gofmt.<br></td></tr
><tr
...
><td class="source">&quot; This filetype plugin add a new commands for go buffers:<br></td></tr
><tr
...
><td class="source">&quot;       Filter the current Go buffer through gofmt.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_12

><td class="source">&quot;       It tries to preserve cursor position and avoids<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_13

><td class="source">&quot;       replacing the buffer with stderr output.<br></td></tr
><tr
...
><td class="source">command! -buffer Fmt call s:GoFormat()<br></td></tr
><tr
...
><td class="source">function! s:GoFormat()<br></td></tr
><tr
...
><td class="source">        endfor<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_32

><td class="source">        if empty(errors)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_33

><td class="source">            % | &quot; Couldn&#39;t detect gofmt error format, output errors<br></td></tr
><tr
...
><td class="source">            call setloclist(0, errors, &#39;r&#39;)<br></td></tr
><tr
...
><td class="source">        echohl Error | echomsg &quot;Gofmt returned error&quot; | echohl None<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&amp;r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863">d7460049e3bf</a>
 by Paul Sbarra &lt;Sbarra.Paul&gt;
 on Sep 22, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863&amp;format=side&amp;path=/misc/vim/ftplugin/go/fmt.vim&amp;old_path=/misc/vim/ftplugin/go/fmt.vim&amp;old=0b1f004f9c1865461394bf3101dbbb39095fc3eb">Diff</a>
 </div>
 <pre>vim: Send GoFmt errors to a location list

R=golang-dev, dsymonds
CC=golang-dev
<a href="http://codereview.appspot.com/5043046" rel="nofollow">http://codereview.appspot.com/5043046</a>
...
&lt;dsymonds@golang.org&gt;</pre>
 ...
 <script type="text/javascript">
 var detail_url = '/p/go/source/detail?r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9';
 var publish_url = '/p/go/source/detail?r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/misc/vim/ftplugin/go/fmt.vim');
 changed_urls.push('/p/go/source/browse/misc/vim/ftplugin/go/fmt.vim?r\x3dd7460049e3bfd06cbf43c72c84c3fdb52b76a863\x26spec\x3dsvn272e1dd72156cbe4b548c37be8285f38c39ccbb9');
 
 var selected_path = '/misc/vim/ftplugin/go/fmt.vim';
 ...
 <option value="/p/go/source/browse/misc/vim/ftplugin/go/fmt.vim?r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863&amp;spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9"
 selected="selected"
 >/misc/vim/ftplugin/go/fmt.vim</option>
 ...
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=0b1f004f9c1865461394bf3101dbbb39095fc3eb">0b1f004f9c18</a>
 by Yasuhiro Matsumoto &lt;mattn.jp&gt;
 on May 29, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=0b1f004f9c1865461394bf3101dbbb39095fc3eb&amp;format=side&amp;path=/misc/vim/ftplugin/go/fmt.vim&amp;old_path=/misc/vim/ftplugin/go/fmt.vim&amp;old=79173f40bb9daf093751d30693662fad8f7692c2">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim: limit Fmt command to Go
buffers.
...
...</pre>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=79173f40bb9daf093751d30693662fad8f7692c2">79173f40bb9d</a>
 by Dmitry Chestnykh &lt;dchest&gt;
 on Apr 12, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=79173f40bb9daf093751d30693662fad8f7692c2&amp;format=side&amp;path=/misc/vim/ftplugin/go/fmt.vim&amp;old_path=/misc/vim/ftplugin/go/fmt.vim&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim: add plugin with Fmt command.

Fmt command filters the current Go
buffer through gofmt.
It tries to preserve cursor position
...</pre>
 </div>
 
 
 <a href="/p/go/source/list?path=/misc/vim/ftplugin/go/fmt.vim&r=d7460049e3bfd06cbf43c72c84c3fdb52b76a863">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//go.googlecode.com/hg/misc/vim/ftplugin/go/fmt.vim">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn272e1dd72156cbe4b548c37be8285f38c39ccbb9': '/misc/vim/ftplugin/go/fmt.vim'}
