...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftdetect%2Fgofiletype.vim&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fftdetect%2Fgofiletype.vim" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/go/source/browse/misc/">misc</a><span class="sp">/&nbsp;</span><a href="/p/go/source/browse/misc/vim/">vim</a><span class="sp">/&nbsp;</span><a href="/p/go/source/browse/misc/vim/ftdetect/">ftdetect</a><span class="sp">/&nbsp;</span>gofiletype.vim</span>
 ...
 <li><a href="/p/go/source/browse/misc/vim/ftdetect/gofiletype.vim?r=fe3bea7c6c36280060a54a2f29e7494e87cb4744" title="Previous">&lsaquo;fe3bea7c6c36</a></li>
...
><td class="source">&quot; We take care to preserve the user&#39;s fileencodings and fileformats,<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_2

><td class="source">&quot; because those settings are global (not buffer local), yet we want<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_3

><td class="source">&quot; to override them for loading Go files, which are defined to be UTF-8.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_4

><td class="source">let s:current_fileformats = &#39;&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_5

><td class="source">let s:current_fileencodings = &#39;&#39;<br></td></tr
><tr
...
><td class="source">&quot; define fileencodings to open as utf-8 encoding even if it&#39;s ascii.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_8

><td class="source">function! s:gofiletype_pre()<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_9

><td class="source">  let s:current_fileformats = &amp;g:fileformats<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_10

><td class="source">  let s:current_fileencodings = &amp;g:fileencodings<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_11

><td class="source">  set fileencodings=utf-8 fileformats=unix<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_12

><td class="source">  setlocal filetype=go<br></td></tr
><tr
...
><td class="source">&quot; restore fileencodings as others<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_16

><td class="source">function! s:gofiletype_post()<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_17

><td class="source">  let &amp;g:fileformats = s:current_fileformats<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_18

><td class="source">  let &amp;g:fileencodings = s:current_fileencodings<br></td></tr
><tr
...
><td class="source">au BufNewFile *.go setlocal filetype=go fileencoding=utf-8 fileformat=unix<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_22

><td class="source">au BufRead *.go call s:gofiletype_pre()<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_23

><td class="source">au BufReadPost *.go call s:gofiletype_post()<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&amp;r=ca61f2a46162ee623a88f27298cdca5cd0de62a4">ca61f2a46162</a>
 by Yasuhiro Matsumoto &lt;mattn.jp&gt;
 on Mar 14, 2012
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=ca61f2a46162ee623a88f27298cdca5cd0de62a4&amp;format=side&amp;path=/misc/vim/ftdetect/gofiletype.vim&amp;old_path=/misc/vim/ftdetect/gofiletype.vim&amp;old=fe3bea7c6c36280060a54a2f29e7494e87cb4744">Diff</a>
 </div>
 <pre>misc/vim: restore fileencodings.
Currently, ftdetect/gofiletype.vim set
fileencodings to open the file as
utf-8 encoding event if the file does not
...
...</pre>
 ...
 <script type="text/javascript">
 var detail_url = '/p/go/source/detail?r=ca61f2a46162ee623a88f27298cdca5cd0de62a4&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9';
 var publish_url = '/p/go/source/detail?r=ca61f2a46162ee623a88f27298cdca5cd0de62a4&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/misc/vim/ftdetect/gofiletype.vim');
 changed_urls.push('/p/go/source/browse/misc/vim/ftdetect/gofiletype.vim?r\x3dca61f2a46162ee623a88f27298cdca5cd0de62a4\x26spec\x3dsvn272e1dd72156cbe4b548c37be8285f38c39ccbb9');
 
 var selected_path = '/misc/vim/ftdetect/gofiletype.vim';
 ...
 <option value="/p/go/source/browse/misc/vim/ftdetect/gofiletype.vim?r=ca61f2a46162ee623a88f27298cdca5cd0de62a4&amp;spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9"
 selected="selected"
 >/misc/vim/ftdetect/gofiletype.vim</option>
 ...
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=fe3bea7c6c36280060a54a2f29e7494e87cb4744">fe3bea7c6c36</a>
 by Paul Sbarra &lt;Sbarra.Paul&gt;
 on Dec 18, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=fe3bea7c6c36280060a54a2f29e7494e87cb4744&amp;format=side&amp;path=/misc/vim/ftdetect/gofiletype.vim&amp;old_path=/misc/vim/ftdetect/gofiletype.vim&amp;old=fcb55e9457d8e86263f484afb0bd923d085d9ffa">Diff</a>
 <br>
 <pre class="ifOpened">vim: fix go filetype detection

The filetype needs to be set during
BufRead in order for the
did_filetype() check to prevent the
...</pre>
 </div>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=fcb55e9457d8e86263f484afb0bd923d085d9ffa">fcb55e9457d8</a>
 by Yasuhiro Matsumoto &lt;mattn.jp&gt;
 on Jun 30, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=fcb55e9457d8e86263f484afb0bd923d085d9ffa&amp;format=side&amp;path=/misc/vim/ftdetect/gofiletype.vim&amp;old_path=/misc/vim/ftdetect/gofiletype.vim&amp;old=c051dc36c4160d0c33c44fc01b6573420f716ef8">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim:  allow only utf-8 for
fileencoding (fix CL4625078).
...
...</pre>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=c051dc36c4160d0c33c44fc01b6573420f716ef8">c051dc36c416</a>
 by Yasuhiro Matsumoto &lt;mattn.jp&gt;
 on Jun 29, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=c051dc36c4160d0c33c44fc01b6573420f716ef8&amp;format=side&amp;path=/misc/vim/ftdetect/gofiletype.vim&amp;old_path=/misc/vim/ftdetect/gofiletype.vim&amp;old=23d5aba3fbc9f84665b7395f973eb96a58300507">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim: allow only utf-8 for
fileencoding.
...
...</pre>
 ...
 <a href="/p/go/source/list?path=/misc/vim/ftdetect/gofiletype.vim&r=ca61f2a46162ee623a88f27298cdca5cd0de62a4">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//go.googlecode.com/hg/misc/vim/ftdetect/gofiletype.vim">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn272e1dd72156cbe4b548c37be8285f38c39ccbb9': '/misc/vim/ftdetect/gofiletype.vim'}
