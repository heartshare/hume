...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Findent%2Fgo.vim&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Findent%2Fgo.vim" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/go/source/browse/misc/">misc</a><span class="sp">/&nbsp;</span><a href="/p/go/source/browse/misc/vim/">vim</a><span class="sp">/&nbsp;</span><a href="/p/go/source/browse/misc/vim/indent/">indent</a><span class="sp">/&nbsp;</span>go.vim</span>
 ...
 <li><a href="/p/go/source/browse/misc/vim/indent/go.vim?r=4a52fe7518538bf70e6fc14921ae190d964a68db" title="Previous">&lsaquo;4a52fe751853</a></li>
...
><td class="source">&quot; indent/go.vim: Vim indent file for Go.<br></td></tr
><tr
...
><td class="source">&quot; - function invocations split across lines<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_9

><td class="source">&quot; - general line splits (line ends in an operator)<br></td></tr
><tr
...
><td class="source">if exists(&quot;b:did_indent&quot;)<br></td></tr
><tr
...
><td class="source">let b:did_indent = 1<br></td></tr
><tr
...
><td class="source">&quot; C indentation is too far off useful, mainly due to Go&#39;s := operator.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_17

><td class="source">&quot; Let&#39;s just define our own.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_18

><td class="source">setlocal nolisp<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_19

><td class="source">setlocal autoindent<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_20

><td class="source">setlocal indentexpr=GoIndent(v:lnum)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_21

><td class="source">setlocal indentkeys+=&lt;:&gt;,0=},0=)<br></td></tr
><tr
...
><td class="source">if exists(&quot;*GoIndent&quot;)<br></td></tr
><tr
...
><td class="source">function! GoIndent(lnum)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_28

><td class="source">  let prevlnum = prevnonblank(a:lnum-1)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_29

><td class="source">  if prevlnum == 0<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_30

><td class="source">    &quot; top of file<br></td></tr
><tr
...
><td class="source">  &quot; grab the previous and current line, stripping comments.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_35

><td class="source">  let prevl = substitute(getline(prevlnum), &#39;//.*$&#39;, &#39;&#39;, &#39;&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_36

><td class="source">  let thisl = substitute(getline(a:lnum), &#39;//.*$&#39;, &#39;&#39;, &#39;&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_37

><td class="source">  let previ = indent(prevlnum)<br></td></tr
><tr
...
><td class="source">  let ind = previ<br></td></tr
><tr
...
><td class="source">  if prevl =~ &#39;[({]\s*$&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_42

><td class="source">    &quot; previous line opened a block<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_43

><td class="source">    let ind += &amp;sw<br></td></tr
><tr
...
><td class="source">  if prevl =~# &#39;^\s*\(case .*\|default\):$&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_46

><td class="source">    &quot; previous line is part of a switch statement<br></td></tr
><tr
...
><td class="source">  &quot; TODO: handle if the previous line is a label.<br></td></tr
><tr
...
><td class="source">  if thisl =~ &#39;^\s*[)}]&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_52

><td class="source">    &quot; this line closed a block<br></td></tr
><tr
...
><td class="source">  &quot; Colons are tricky.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_57

><td class="source">  &quot; We want to outdent if it&#39;s part of a switch (&quot;case foo:&quot; or &quot;default:&quot;).<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_58

><td class="source">  &quot; We ignore trying to deal with jump labels because (a) they&#39;re rare, and<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_59

><td class="source">  &quot; (b) they&#39;re hard to disambiguate from a composite literal key.<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_60

><td class="source">  if thisl =~# &#39;^\s*\(case .*\|default\):$&#39;<br></td></tr
><tr
...
><td class="source">  return ind<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&amp;r=7ffedf93f1b356b2010eaff437f6e44938b69c44">7ffedf93f1b3</a>
 by David Symonds &lt;dsymo...@golang.org&gt;
 on May 14, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=7ffedf93f1b356b2010eaff437f6e44938b69c44&amp;format=side&amp;path=/misc/vim/indent/go.vim&amp;old_path=/misc/vim/indent/go.vim&amp;old=4a52fe7518538bf70e6fc14921ae190d964a68db">Diff</a>
 </div>
 <pre>misc/vim: drop indent support for jump
labels.

It interferes with keys in composite
literals,
which are much more common.

R=dchest, jnwhiteh, rlight2
CC=golang-dev
<a href="http://codereview.appspot.com/4521065" rel="nofollow">http://codereview.appspot.com/4521065</a></pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/go/source/detail?r=7ffedf93f1b356b2010eaff437f6e44938b69c44&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9';
 var publish_url = '/p/go/source/detail?r=7ffedf93f1b356b2010eaff437f6e44938b69c44&spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/misc/vim/indent/go.vim');
 changed_urls.push('/p/go/source/browse/misc/vim/indent/go.vim?r\x3d7ffedf93f1b356b2010eaff437f6e44938b69c44\x26spec\x3dsvn272e1dd72156cbe4b548c37be8285f38c39ccbb9');
 
 var selected_path = '/misc/vim/indent/go.vim';
 ...
 <option value="/p/go/source/browse/misc/vim/indent/go.vim?r=7ffedf93f1b356b2010eaff437f6e44938b69c44&amp;spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9"
 selected="selected"
 >/misc/vim/indent/go.vim</option>
 ...
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=4a52fe7518538bf70e6fc14921ae190d964a68db">4a52fe751853</a>
 by David Symonds &lt;dsymo...@golang.org&gt;
 on May 13, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=4a52fe7518538bf70e6fc14921ae190d964a68db&amp;format=side&amp;path=/misc/vim/indent/go.vim&amp;old_path=/misc/vim/indent/go.vim&amp;old=5b833234829366df3dd46eafb2c1577ce7aeee6f">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim: new Vim indentation script.

This uses a fully custom function for
indenting Go code in Vim.
...
...</pre>
 ...
 <img class="ifClosed" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/plus.gif" >
 <img class="ifOpened" onclick="_toggleHidden(this)" src="http://www.gstatic.com/codesite/ph/images/minus.gif" >
 <a href="/p/go/source/detail?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=5b833234829366df3dd46eafb2c1577ce7aeee6f">5b8332348293</a>
 by Ross Light &lt;rlight2&gt;
 on Mar 7, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=5b833234829366df3dd46eafb2c1577ce7aeee6f&amp;format=side&amp;path=/misc/vim/indent/go.vim&amp;old_path=/misc/vim/indent/go.vim&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">misc/vim: Add indent script for Vim

R=adg
CC=golang-dev
<a href="http://codereview.appspot.com/4258041" rel="nofollow">http://codereview.appspot.com/4258041</a>
...</pre>
 </div>
 
 
 <a href="/p/go/source/list?path=/misc/vim/indent/go.vim&r=7ffedf93f1b356b2010eaff437f6e44938b69c44">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//go.googlecode.com/hg/misc/vim/indent/go.vim">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn272e1dd72156cbe4b548c37be8285f38c39ccbb9': '/misc/vim/indent/go.vim'}
