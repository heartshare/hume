...
<div class="headbg">
 ...
 | <a href="https://www.google.com/accounts/ServiceLogin?service=code&amp;ltmpl=phosting&amp;continue=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fautoload%2Fgo%2Fcomplete.vim&amp;followup=http%3A%2F%2Fcode.google.com%2Fp%2Fgo%2Fsource%2Fbrowse%2Fmisc%2Fvim%2Fautoload%2Fgo%2Fcomplete.vim" onclick="_CS_click('/gb/ph/signin');"><u>Sign in</u></a>
...
<table id="nav_and_rev" class="list"
 ...
 <li><a href="/p/go/source/browse/misc/vim/autoload/go/complete.vim?r=1ce42d48298d0ef498d342a278f2fe615e673bcb" title="Previous">&lsaquo;1ce42d48298d</a></li>
...
><td class="source">&quot; This file provides a utility function that performs auto-completion of<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_6

><td class="source">&quot; package names, for use by other commands.<br></td></tr
><tr
...
><td class="source">let s:goos = $GOOS<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_9

><td class="source">let s:goarch = $GOARCH<br></td></tr
><tr
...
><td class="source">if len(s:goos) == 0<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_12

><td class="source">  if exists(&#39;g:golang_goos&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_13

><td class="source">    let s:goos = g:golang_goos<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_14

><td class="source">  elseif has(&#39;win32&#39;) || has(&#39;win64&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_15

><td class="source">    let s:goos = &#39;windows&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_16

><td class="source">  elseif has(&#39;macunix&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_17

><td class="source">    let s:goos = &#39;darwin&#39;<br></td></tr
><tr
...
><td class="source">    let s:goos = &#39;*&#39;<br></td></tr
><tr
...
><td class="source">if len(s:goarch) == 0<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_24

><td class="source">  if exists(&#39;g:golang_goarch&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_25

><td class="source">    let s:goarch = g:golang_goarch<br></td></tr
><tr
...
><td class="source">    let s:goarch = &#39;*&#39;<br></td></tr
><tr
...
><td class="source">function! go#complete#Package(ArgLead, CmdLine, CursorPos)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_32

><td class="source">  let dirs = []<br></td></tr
><tr
...
><td class="source">  if executable(&#39;go&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_35

><td class="source">      let goroot = substitute(system(&#39;go env GOROOT&#39;), &#39;\n&#39;, &#39;&#39;, &#39;g&#39;)<br></td></tr
><tr
...
><td class="source">          echo &#39;\&#39;go env GOROOT\&#39; failed&#39;<br></td></tr
><tr
...
><td class="source">      let goroot = $GOROOT<br></td></tr
><tr
...
><td class="source">  if len(goroot) != 0 &amp;&amp; isdirectory(goroot)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_44

><td class="source">    let dirs += [ goroot ]<br></td></tr
><tr
...
><td class="source">  let workspaces = split($GOPATH, &#39;:&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_48

><td class="source">  if workspaces != []<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_49

><td class="source">      let dirs += workspaces<br></td></tr
><tr
...
><td class="source">  if len(dirs) == 0<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_53

><td class="source">      &quot; should not happen<br></td></tr
><tr
...
><td class="source">  let ret = {}<br></td></tr
><tr
...
><td class="source">    let root = expand(dir . &#39;/pkg/&#39; . s:goos . &#39;_&#39; . s:goarch)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_60

><td class="source">    for i in split(globpath(root, a:ArgLead.&#39;*&#39;), &quot;\n&quot;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_61

><td class="source">      if isdirectory(i)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_62

><td class="source">        let i .= &#39;/&#39;<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_63

><td class="source">      elseif i !~ &#39;\.a$&#39;<br></td></tr
><tr
...
><td class="source">      let i = substitute(substitute(i[len(root)+1:], &#39;[\\]&#39;, &#39;/&#39;, &#39;g&#39;), &#39;\.a$&#39;, &#39;&#39;, &#39;g&#39;)<br></td></tr
><tr
id=sl_svn272e1dd72156cbe4b548c37be8285f38c39ccbb9_67

><td class="source">      let ret[i] = i<br></td></tr
><tr
...
><td class="source">  return sort(keys(ret))<br></td></tr
><tr
...
<script type="text/javascript">
 ...
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=7fb0e868dc39677df0bf041d42bbf40053c3a418&amp;format=side&amp;path=/misc/vim/autoload/go/complete.vim&amp;old_path=/misc/vim/autoload/go/complete.vim&amp;old=1ce42d48298d0ef498d342a278f2fe615e673bcb">Diff</a>
 </div>
...
...</pre>
 ...
 var selected_path = '/misc/vim/autoload/go/complete.vim';
 ...
 on Aug 17, 2011
 &nbsp; <a href="/p/go/source/diff?spec=svn272e1dd72156cbe4b548c37be8285f38c39ccbb9&r=1ce42d48298d0ef498d342a278f2fe615e673bcb&amp;format=side&amp;path=/misc/vim/autoload/go/complete.vim&amp;old_path=/misc/vim/autoload/go/complete.vim&amp;old=">Diff</a>
 <br>
...
...</pre>
 ...
 <a href="/p/go/source/list?path=/misc/vim/autoload/go/complete.vim&r=7fb0e868dc39677df0bf041d42bbf40053c3a418">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//go.googlecode.com/hg/misc/vim/autoload/go/complete.vim">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn272e1dd72156cbe4b548c37be8285f38c39ccbb9': '/misc/vim/autoload/go/complete.vim'}
